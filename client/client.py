...
while stillInMenu:
    ...
    match startUp():
        ...
        case 1:
            ...
            result = r.post("http://127.0.0.1:4200/todo-list", json={'name' : name})
        ...
        case 2:
            ...
            if list_selected is not False:
                result = r.delete("http://127.0.0.1:4200/todo-list/" + list_selected)
                if(result.status_code == 200):
        ...
        case 3:
            ...
            if list_selected is not False:
                ...
                result = r.patch("http://127.0.0.1:4200/todo-list/" + list_selected, json={'name' : name})
                if(result.status_code == 200):
        ...
        case 4:
            ...
            if list_selected is not False:
                ...
                result = r.post("http://127.0.0.1:4200/todo-list/" + list_selected + "/entry", json={'name' : name, 'description' : description})
        ...
        case 5:
            ...
            if entry_selected is not False:
                ...
                result = r.patch("http://127.0.0.1:4200/entry/" + entry_selected, json={'name' : name, 'description' : description})
        ...
        case 6:
            ...
            if entry_selected is not False:
                result = r.delete("http://127.0.0.1:4200/entry/" + entry_selected)
        ...
        case 7:
            ...
            if list_selected is not False:
                result = r.get("http://127.0.0.1:4200/todo-list/" + list_selected)
